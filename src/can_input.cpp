...
Can_Data read_input() {
  ...
  while (can.readMessage(message, 10) == ESP_OK) {
    ...
    case 0x100: current_state.engine_rpm = message.getFloat(); break;
    case 0x101: current_state.secondary_rpm = message.getFloat(); break;
    case 0x200: current_state.motor_point = message.getInt32(); break;
    }
  }
